...
export default function OptimizationHeader() {
  return (
    <header className="relative z-20 border-b border-white/5 backdrop-blur-xl bg-gray-950/50">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <Link href="/" className="flex items-center gap-3 group">
            ...
            <span className="text-white font-light text-lg">提示词优化器</span>
          </Link>
          ...
          <div className="flex items-center gap-3">
            <button className="p-2 rounded-lg text-gray-400 hover:text-white hover:bg-white/[0.05] transition-all">
